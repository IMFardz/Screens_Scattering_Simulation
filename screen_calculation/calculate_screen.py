...
if __name__=="__main__":
    ...
    subprocess.run("python ar_yy_delay.py {0} {1} {2} {3}".format(d1, d2, as1, as2), shell=True, check=True)
    ar_yy_delay, curvature = np.load("delay.npy")
    print(ar_yy_delay, curvature)

    subprocess.run("python ar_jb_delay.py {0} {1} {2} {3}".format(d1, d2, as1, as2), shell=True, check=True)
    ar_jb_delay, curvature = np.load("delay.npy")
    print(ar_jb_delay, curvature)

    calculate_screen_parameters(ar_yy_delay*u.s, ar_jb_delay*u.s, curvature*u.s**3)
