...
In this altered version I change it so that the screens do not see each other
"""
...
s2 = Screen1D(CylindricalRepresentation(1., 70*u.deg, 0.).to_cartesian(),
              2*np.array([-0.711, -0.62, -0.53, -0.304, -0.111, -0.052, -0.031,0.0001, 0.0201, 0.0514, 0.102, 0.199, 0.3001, 0.409])*u.AU,
